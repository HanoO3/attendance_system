...
Route::middleware(['auth', 'role:teacher'])->group(function () {
    ...
    Route::post('/teacher/send-profile-request', [TeacherController::class, 'sendProfileRequest'])->name('teacher.sendProfileRequest');
});

// ==========================================
// Subjects Management (Admin & Super Admin only)
// ==========================================
